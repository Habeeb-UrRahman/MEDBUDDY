...
# dataset_path = 'D:\Coding\Reva Hackathon 2023\MEDBUDDY\disease_images'
# img_files = []
...
# pickle.dump(image_features, open("image_features_embedding_skin_disease.pkl", "wb"))
# pickle.dump(disease_names_list, open("disease_names_skin_disease.pkl", "wb"))
...
pickle.dump(img_files, open("img_files_skin_disease.pkl", "wb"))
